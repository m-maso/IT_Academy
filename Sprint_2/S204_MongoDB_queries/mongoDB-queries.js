...
// 8. Escriu una consulta per trobar els restaurants que tenen un score de més de 90.
    //si entenem trobar restaurants com només indicar noms dels restaurants amb aquesta condició
db.restaurants.find({"grades.score": {$gt: 90}}, {_id:0, name:1}); 
    //si volem veure tots els camps dels restaurants amb aquesta condició
    db.restaurants.find({"grades.score": {$gt: 90}});
    
// 9. Escriu una consulta per trobar els restaurants que tenen un score de més de 80 però menys que 100. ($elemMatch: for an array elem that meets multiple criteria)
db.restaurants.find({grades: {$elemMatch: {score: {$gt: 80, $lt: 100}} }}, {_id:0, name:1, "grades.score":1}); 
...
db.restaurants.find({name: /mon/}, {_id:0, name: 1, borough: 1, "adress.coord": 1, cuisine: 1});
